...
while ($row = mysqli_fetch_array($alldata)) {
    ...
    <div class="col-md-6 col-12">
     ...
     <img src='<?php echo $row['image']; ?>' class="card-img-top p-3" alt="...">
          <div class="card-body text-center">
              ...
              <button class="btn btn-success fw-bold rounded-pill mt-3  px-5"><a class="edit" href="update.php">Update</a></button>
              <button class="btn btn-danger fw-bold rounded-pill mt-3  px-5"><a class="edit" href="delete.php">Delete</a></button>
          </div>
      </div>
      </div>
